# This is a funny game where you try guessing the color of the winning turtle. It uses the Turtle module.

# Isto é um jogo divertido onde você tenta adivinhar a cor da tartaruga vencedora. Ele usa o módulo Turtle.

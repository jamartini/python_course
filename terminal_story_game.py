# This is a game supposed to be played in the terminal, like an interactive story.
# It should demonstrate the usage of if statements.

# Isso é um jogo a ser jogado no terminal, como uma história interativa.
# Ele serve pra demonstrar o uso de if statements.

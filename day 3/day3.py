...
direction = str(input("You're in a forest and you see a cave, and you feel like you should enter it. After walking for a few minutes you can see it goes in two different directions, type 'left' if you want to go left or type 'right' if you want to go right."))

if direction == "left":
  print("The cave goes deeper and you can smell something that's not that good and you start to regret your choice, but it's already too late as you see two fierce eyes get near your face and you realize it's your end. Game over.")
elif direction == "right":
  yell = str(input("The cave goes foreward and you end up in a place that seems like a very large room, you can yell something to anlyze the echo or to see if something shows up (type 'yes') or you can go further and try to recognize the place by hand (type 'no')."))
  if yell == "yes":
